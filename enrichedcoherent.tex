...
Among the important technical results proven in this chapter, we direct the attention of the reader to \Cref{horizontal}, proving that the model structure is Cartesian-monoidal as well as \Cref{rezkcomparison}, proving a useful equivalence with an analogous model structure constructed by Rezk.    
